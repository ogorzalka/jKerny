...
(function ($) {
    ...
    $.jkerny = {
        ...
        only_selectors: [/span\.jkerny-(word|letter)/],
	            ...
	            for (var selector in selectors) {
	                ...
	                if (typeof selectors[selector]['-jkerny-letter-spacing'] != 'undefined') {
	                    ...
	                    for (var i = 0; i <= letterSpacingValues.length; i++) {
	                        jkerny.applyCss(selector + (selector.indexOf('span.jkerny-word') > -1 ? '' : ' span.jkerny-word') + (selector.indexOf('span.jkerny-letter') > -1 ? '' : ' span') + ':eq(' + i + ')', {
	                ...
	                if (typeof selectors[selector]['-jkerny-word-spacing'] != 'undefined') {
	                    ...
	                    for (var i = 0; i <= letterSpacingValues.length; i++) {
	                        jkerny.applyCss(selector + (selector.indexOf('span.jkerny-word') > -1 ? '' : ' span.jkerny-word') + ':eq(' + i + ')', {
	                            marginRight: letterSpacingValues[i]
	                        });
	                    }
	                }
	                
	                for (var regexp_expr in jkerny.only_selectors) {
						if (selector.match(jkerny.only_selectors[regexp_expr])) {
						    cssStyle += jkerny.rawCss(selector, selectors[selector]);
						}
	                }
	            }
	            $('<style'+(jkerny.medias_screen !== false ? ' media="'+jkerny.medias_screen+'"' : '')+' rel="jkerny">' + cssStyle + '</style>').appendTo('body');
            }
        },
