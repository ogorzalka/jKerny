...
(function ($) {
    ...
    $.jkerny = {
        lettering_replace: {
        	':((first|last)-)?(letter|word)' : '\._$1$3',
            '\._word *\._first-letter': 'span.jkerny-word span.jkerny-letter:first-child',
            '\._word *_last-letter': 'span.jkerny-word span.jkerny-letter:last-child',
            '\._(letter|word)': 'span.jkerny-$1',
            '\._first-word': 'span.jkerny-word:first-child',
            '\._last-word': 'span.jkerny-word:last-child',
            '\._first-letter': 'span.jkerny-word:first-child span.jkerny-letter:first-child',
            '\._last-letter': 'span.jkerny-word:last-child span.jkerny-letter:last-child'
        },
        ...
        run: function () {
            ...
            $('style:not([rel=jkerny]),link[rel=stylesheet]').each(function () {
            	...
            	if(
            		this.href
            	    && !this.disabled 
            	    && !(this.href.indexOf('//'+window.location.host) < 0 && /^\w+:/.test(this.href)) 
            	) {
                    $.ajax({
                        url: this.href,
